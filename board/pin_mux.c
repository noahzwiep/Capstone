...
board: FRDM-K64F
pin_labels:
- {pin_num: '90', pin_signal: PTC16/UART3_RX/ENET0_1588_TMR0/FB_CS5_b/FB_TSIZ1/FB_BE23_16_BLS15_8_b, label: 'J1[2]', identifier: TMR_1588_0;GPS_RX}
- {pin_num: '91', pin_signal: PTC17/UART3_TX/ENET0_1588_TMR1/FB_CS4_b/FB_TSIZ0/FB_BE31_24_BLS7_0_b, label: 'J1[4]', identifier: TMR_1588_1;GPS_TX}
- {pin_num: '57', pin_signal: PTB9/SPI1_PCS1/UART3_CTS_b/FB_AD20, label: 'J1[6]', identifier: ENCODER_1;ENCODER1}
- {pin_num: '35', pin_signal: PTA1/UART0_RX/FTM0_CH6/JTAG_TDI/EZP_DI, label: 'J1[8]', identifier: ENCODER2}
- {pin_num: '69', pin_signal: PTB23/SPI2_SIN/SPI0_PCS5/FB_AD28, label: 'J1[10]', identifier: RIGHT_MOTOR_A}
- {pin_num: '36', pin_signal: PTA2/UART0_TX/FTM0_CH7/JTAG_TDO/TRACE_SWO/EZP_DO, label: 'J1[12]/J9[6]/TRACE_SWO', identifier: RIGHT_MOTOR_B}
- {pin_num: '72', pin_signal: ADC0_SE4b/CMP1_IN0/PTC2/SPI0_PCS2/UART1_CTS_b/FTM0_CH1/FB_AD12/I2S0_TX_FS, label: 'J1[14]', identifier: MOTOR_EN}
...
- {pin_num: '95', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/I2C0_SCL, label: 'J2[8]', identifier: UART2_RX;REAR_RPM}
- {pin_num: '96', pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/I2C0_SDA, label: 'J2[10]', identifier: UART2_TX;FRONT_LEFT_RPM}
- {pin_num: '94', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/UART2_CTS_b/FTM3_CH1/FB_CS0_b, label: 'J2[12]', identifier: FRONT_RIGHT_RPM}
...
- {pin_num: '33', pin_signal: PTE26/ENET_1588_CLKIN/UART4_CTS_b/RTC_CLKOUT/USB_CLKIN, label: 'J2[1]/D12[4]/LEDRGB_GREEN', identifier: LED_GREEN;LED_ERROR}
...
- {pin_num: '59', pin_signal: ADC1_SE15/PTB11/SPI1_SCK/UART3_TX/FB_AD18/FTM0_FLT2, label: 'J4[8]', identifier: MPU6050_INTERRUPT}
- {pin_num: '83', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, label: 'J4[10]', identifier: RIGHT_ENCODER_2}
- {pin_num: '82', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, label: 'J4[12]', identifier: RIGHT_ENCODER_1}
...
- pin_list:
  ...
  - {pin_num: '76', peripheral: FTM0, signal: 'CH, 3', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, direction: OUTPUT}
  ...
  - {pin_num: '35', peripheral: GPIOA, signal: 'GPIO, 1', pin_signal: PTA1/UART0_RX/FTM0_CH6/JTAG_TDI/EZP_DI, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
  ...
  - {pin_num: '82', peripheral: GPIOC, signal: 'GPIO, 10', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    pull_select: up}
  - {pin_num: '83', peripheral: GPIOC, signal: 'GPIO, 11', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    pull_select: up}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t ENCODER2_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA1 (pin 35)  */
    GPIO_PinInit(BOARD_ENCODER2_GPIO, BOARD_ENCODER2_PIN, &ENCODER2_config);

    gpio_pin_config_t RIGHT_MOTOR_B_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA2 (pin 36)  */
    GPIO_PinInit(BOARD_RIGHT_MOTOR_B_GPIO, BOARD_RIGHT_MOTOR_B_PIN, &RIGHT_MOTOR_B_config);

    gpio_pin_config_t ENCODER1_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB9 (pin 57)  */
    GPIO_PinInit(BOARD_ENCODER1_GPIO, BOARD_ENCODER1_PIN, &ENCODER1_config);

    gpio_pin_config_t MPU6050_INTERRUPT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB11 (pin 59)  */
    GPIO_PinInit(BOARD_MPU6050_INTERRUPT_GPIO, BOARD_MPU6050_INTERRUPT_PIN, &MPU6050_INTERRUPT_config);

    gpio_pin_config_t RIGHT_MOTOR_A_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    ...
    GPIO_PinInit(BOARD_MOTOR_EN_GPIO, BOARD_MOTOR_EN_PIN, &MOTOR_EN_config);

    gpio_pin_config_t LEFT_MOTOR_A_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC3 (pin 73)  */
    GPIO_PinInit(BOARD_LEFT_MOTOR_A_GPIO, BOARD_LEFT_MOTOR_A_PIN, &LEFT_MOTOR_A_config);

    gpio_pin_config_t FRONT_LEFT_LIMIT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC5 (pin 77)  */
    GPIO_PinInit(BOARD_FRONT_LEFT_LIMIT_GPIO, BOARD_FRONT_LEFT_LIMIT_PIN, &FRONT_LEFT_LIMIT_config);

    gpio_pin_config_t FRONT_RIGHT_LIMIT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    ...
    GPIO_PinInit(BOARD_RIGHT_ENCODER_1_GPIO, BOARD_RIGHT_ENCODER_1_PIN, &RIGHT_ENCODER_1_config);

    gpio_pin_config_t RIGHT_ENCODER_2_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC11 (pin 83)  */
    GPIO_PinInit(BOARD_RIGHT_ENCODER_2_GPIO, BOARD_RIGHT_ENCODER_2_PIN, &RIGHT_ENCODER_2_config);

    gpio_pin_config_t LEFT_MOTOR_B_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC12 (pin 84)  */
    GPIO_PinInit(BOARD_LEFT_MOTOR_B_GPIO, BOARD_LEFT_MOTOR_B_PIN, &LEFT_MOTOR_B_config);

    gpio_pin_config_t FRONT_RIGHT_RPM_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD1 (pin 94)  */
    GPIO_PinInit(BOARD_FRONT_RIGHT_RPM_GPIO, BOARD_FRONT_RIGHT_RPM_PIN, &FRONT_RIGHT_RPM_config);

    gpio_pin_config_t REAR_RPM_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD2 (pin 95)  */
    GPIO_PinInit(BOARD_REAR_RPM_GPIO, BOARD_REAR_RPM_PIN, &REAR_RPM_config);

    gpio_pin_config_t FRONT_LEFT_RPM_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD3 (pin 96)  */
    GPIO_PinInit(BOARD_FRONT_LEFT_RPM_GPIO, BOARD_FRONT_LEFT_RPM_PIN, &FRONT_LEFT_RPM_config);

    gpio_pin_config_t LED_ERROR_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTE26 (pin 33)  */
    GPIO_PinInit(BOARD_LED_ERROR_GPIO, BOARD_LED_ERROR_PIN, &LED_ERROR_config);

    /* PORTA1 (pin 35) is configured as PTA1 */
    PORT_SetPinMux(BOARD_ENCODER2_PORT, BOARD_ENCODER2_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTA1 (pin 35): Interrupt on falling edge */
    PORT_SetPinInterruptConfig(BOARD_ENCODER2_PORT, BOARD_ENCODER2_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinMux(BOARD_RIGHT_MOTOR_A_PORT, BOARD_RIGHT_MOTOR_A_PIN, kPORT_MuxAsGpio);

    /* PORTB9 (pin 57) is configured as PTB9 */
    PORT_SetPinMux(BOARD_ENCODER1_PORT, BOARD_ENCODER1_PIN, kPORT_MuxAsGpio);
    ...
    /* Interrupt configuration on PORTC10 (pin 82): Interrupt on falling edge */
    ...
    /* Interrupt configuration on PORTC11 (pin 83): Interrupt on falling edge */
    PORT_SetPinInterruptConfig(BOARD_RIGHT_ENCODER_2_PORT, BOARD_RIGHT_ENCODER_2_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinMux(BOARD_LEFT_MOTOR_B_PORT, BOARD_LEFT_MOTOR_B_PIN, kPORT_MuxAsGpio);

    /* PORTC16 (pin 90) is configured as UART3_RX */
    PORT_SetPinMux(BOARD_GPS_RX_PORT, BOARD_GPS_RX_PIN, kPORT_MuxAlt3);

    /* PORTC17 (pin 91) is configured as UART3_TX */
    PORT_SetPinMux(BOARD_GPS_TX_PORT, BOARD_GPS_TX_PIN, kPORT_MuxAlt3);

    /* PORTC2 (pin 72) is configured as PTC2 */
    PORT_SetPinMux(BOARD_MOTOR_EN_PORT, BOARD_MOTOR_EN_PIN, kPORT_MuxAsGpio);

    /* PORTC3 (pin 73) is configured as PTC3 */
    PORT_SetPinMux(BOARD_LEFT_MOTOR_A_PORT, BOARD_LEFT_MOTOR_A_PIN, kPORT_MuxAsGpio);

    /* PORTC4 (pin 76) is configured as FTM0_CH3 */
    PORT_SetPinMux(BOARD_RIGHT_MOTOR_PWM_PORT, BOARD_RIGHT_MOTOR_PWM_PIN, kPORT_MuxAlt4);
    ...
    PORT_SetPinMux(BOARD_FRONT_RIGHT_RPM_PORT, BOARD_FRONT_RIGHT_RPM_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTD1 (pin 94): Interrupt on falling edge */
    ...
    /* Interrupt configuration on PORTD2 (pin 95): Interrupt on falling edge */
    ...
    /* Interrupt configuration on PORTD3 (pin 96): Interrupt on falling edge */
